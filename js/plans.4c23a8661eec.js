import{a as me,b as be,c as fe,d as ve,e as H,f as le,h as ge,i as he}from"./chunk.XPMQ7Z3E.js";import{a as ce}from"./chunk.SGO56GGA.js";import{a as E,b as U,e as L,f as j,i as de,j as pe,k as ae,p as re,q as ue}from"./chunk.W3L4WO6X.js";import{a as m}from"./chunk.XJPUQ4O3.js";var ye=2,Me=new Set(["claude-opus-4-8","claude-sonnet-4-6","claude-opus-4-7","claude-opus-4-6","claude-sonnet-4-5","claude-opus-4-5","claude-opus-4-1"]);function M(e){if(e==null||e==="")return null;let t=Number(e);return Number.isFinite(t)?t:null}function ee(e,t){let n=M(e);return n==null?"\u5F85\u66F4\u65B0":`${t==="USD"?"$":"\xA5"}${n.toLocaleString("zh-CN",{maximumFractionDigits:4})}`}function $e(e){let t=M(e);return t==null?"\u2014":t>=1e6?`${(t/1e6).toLocaleString("zh-CN",{maximumFractionDigits:1})}M`:t>=1e3?`${(t/1e3).toLocaleString("zh-CN",{maximumFractionDigits:0})}K`:t.toLocaleString("zh-CN")}function T(e){return E[e]||e||"\u672A\u77E5"}var xe={};function Pe(e){let t=j(e,xe,E),n=String(t.seo_slug||"").trim(),l=String(t.seo_intro||"").trim(),o=String(t.icon_url||"").trim();return n&&l&&o?`/brands/${encodeURIComponent(n)}/`:""}function oe(e,t){let n=U(e),l=t||n?.iconUrl||"";return H(l,T(e),"brand-icon brand-icon--tab")}function G(e){let t=String(e.raw?.lifecycle_status||"").trim().toLowerCase();if(t)return t==="legacy";if(String(e.vendor||"").trim().toLowerCase()!=="anthropic")return!1;let n=String(e.raw?.model_id||e.raw?.id||e.id||"").trim().toLowerCase().replace(/[._]/g,"-");return Me.has(n)}function se(e){let t=String(e.raw?.release_date||"").trim();if(!t)return null;let n=Date.parse(t);return Number.isFinite(n)?n:null}var W={release:{numeric:!0,raw:se},name:{label:"\u6A21\u578B",numeric:!1},provider:{label:"\u54C1\u724C",numeric:!1},context:{label:"\u4E0A\u4E0B\u6587",numeric:!0,raw:e=>M(e.raw?.context_length)},input:{label:"\u8F93\u5165\uFF08\u5B98\u65B9\u4EF7\uFF09",numeric:!0,raw:e=>M(e.raw?.input_price)},output:{label:"\u8F93\u51FA\uFF08\u5B98\u65B9\u4EF7\uFF09",numeric:!0,raw:e=>M(e.raw?.output_price)}};function Ce(e,t,n){let l=W[t];if(!l)return e;let o=[...e];return o.sort((c,d)=>{if(t==="release"){let u=Number(G(c))-Number(G(d));if(u!==0)return u}let f=0;if(l.numeric){let u=l.raw(c),b=l.raw(d);if(u==null||b==null)return u==null&&b==null?0:u==null?1:-1;f=u-b}else t==="name"?f=(c.modelName||"").localeCompare(d.modelName||"","zh-CN"):t==="provider"&&(f=T(c.vendor).localeCompare(T(d.vendor),"zh-CN"));return n==="desc"?-f:f}),o}function _e(e){let t=new Map;for(let n of e){let l=T(n.vendor),o=t.get(l);o||(o={name:l,vendor:n.vendor,icon:n.providerIconUrl,models:[]},t.set(l,o)),o.models.push(n)}return[...t.values()]}function Oe(e,t){let n=Number(G(t))-Number(G(e));if(n!==0)return n>0;let l=se(e),o=se(t);return l!=null&&o!=null?l>o:l!=null&&o==null}function Ae(e){let t=new Map;for(let n of e){let l=T(n.vendor),o=t.get(l);(!o||Oe(n,o))&&t.set(l,n)}return[...t.values()]}function Ne(e){let t=null;for(let n of e){let l=M(n.raw?.input_price);l==null||l<0||(!t||l<t.value)&&(t={value:l,currency:n.raw?.currency})}return t}function De(e){let t=Ne(e.models),n=[];if(t){let l=t.currency==="USD"?"$":"\xA5";n.push(`\u8F93\u5165 ${l}${t.value.toLocaleString("zh-CN",{maximumFractionDigits:4})} \u8D77`)}return n.push(`${e.models.length} \u4E2A\u6A21\u578B`),`<span class="plan-table-group-summary">${m(n.join(" \xB7 "))}</span>`}var Se={name:e=>String(e.modelName||"").trim()||"\u2014",provider:e=>T(e.vendor),context:e=>$e(e.raw?.context_length),input:e=>ee(e.raw?.input_price,e.raw?.currency),output:e=>ee(e.raw?.output_price,e.raw?.currency)},we=new Set(["\u2014","\u5F85\u66F4\u65B0"]),qe=new Intl.Collator("zh-CN",{numeric:!0,sensitivity:"base"});function ke(e,t){let n=Se[t];return n?String(n(e)||"").trim()||"\u2014":""}function Fe(e,t){let n=new Map;for(let l of e){let o=ke(l,t);n.set(o,(n.get(o)||0)+1)}return Array.from(n.entries()).map(([l,o])=>({value:l,count:o})).sort((l,o)=>{let c=we.has(l.value),d=we.has(o.value);return c!==d?c?1:-1:qe.compare(l.value,o.value)})}function Be(e,t,n){return e!==t?'<svg class="model-price-sort-icon model-price-sort-icon--idle" viewBox="0 0 12 12" aria-hidden="true"><path d="M6 2l2.5 3h-5zM6 10l-2.5-3h5z" fill="currentColor"/></svg>':`<svg class="model-price-sort-icon" viewBox="0 0 12 12" aria-hidden="true"><path d="${n==="asc"?"M6 2l3 4H3z":"M6 10L3 6h6z"}" fill="currentColor"/></svg>`}function Ie(e,t,n){let l=W[e],o=t.column===e&&!!t.value,c=Fe(n,e);return`<button type="button" class="plan-column-filter-trigger model-price-filter-trigger${o?" is-active":""}" data-model-filter-column="${e}" aria-haspopup="menu" aria-expanded="false" title="\u7B5B\u9009${m(l.label)}">
  ...
  </tr>`}function Ee(e,t,n={}){xe=n||{};let l=t.filter(a=>M(a.raw?.input_price)!=null||M(a.raw?.output_price)!=null),o=new Map;for(let a of l){let s=T(a.vendor);o.has(s)||o.set(s,{name:s,icon:a.providerIconUrl,vendor:a.vendor})}let c=[...o.values()].sort((a,s)=>a.name.localeCompare(s.name,"zh-CN")),d="all",f="release",u="desc",b="brand",g="all",w="",x="",h="",S=new Set;function _(){return!!(x&&h&&Se[x])}function D(){return b==="model"?g==="all"?l:l.filter(a=>(a.modelName||"")===g):d==="all"?l:l.filter(a=>T(a.vendor)===d)}function R(){let a=D(),s=w.toLowerCase();return s&&(a=a.filter(i=>String(i.modelName||"").toLowerCase().includes(s)||T(i.vendor).toLowerCase().includes(s))),a}function Y(a){let s=a;return _()&&(s=s.filter(i=>ke(i,x)===h)),Ce(s,f,u)}function C(){return b==="model"?V():q()}function V(){let a=Ae(l).sort((p,$)=>(p.modelName||"").localeCompare($.modelName||"","zh-CN")),s=`<button type="button" class="brand-tab${g==="all"?" is-active":""}" data-model-tab="all">
