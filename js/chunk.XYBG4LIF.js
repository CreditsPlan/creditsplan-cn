import{A as q,B as H,C as ke,D as _e,E as Z,a as g,b as fe,c as me,d as be,e as C,f as Y,g as I,h as M,i as A,j as Q,k as ye,l as K,m as W,n as R,o as B,q as ve,r as he,s as S,t as J,u as X,v as ge,w as xe,x as U,y as N,z as $e}from"./chunk.W3L4WO6X.js";import{a as i,b as F}from"./chunk.XJPUQ4O3.js";var We=new Set(["\u5F85\u66F4\u65B0","\u5F85\u786E\u8BA4","\u8BF7\u4EE5\u5B98\u7F51\u4E3A\u51C6"]);function O(e){let a=String(e??"").trim();return a&&!We.has(a)?a:"\u2014"}function D(e="",a=""){let t=String(a??"").trim();return{column:t?String(e??"").trim():"",value:t}}function ee(e){return!!(e?.column&&e?.value)}function we(e,a,t){return ee(a)?e.filter(n=>t(n,a.column)===a.value):e}var Pe={};function Le(e){Pe=e||{}}function Je(e){let a=I(e,Pe,g);return a.training?M[a.training]||a.training:"\u5F85\u8C03\u7814"}var Xe={token:"Token \u8BA1\u8D39",credits:"\u79EF\u5206\u5236",five_hours:"\u8BF7\u6C42\u6B21\u6570",weekly:"\u8BF7\u6C42\u6B21\u6570",monthly:"\u8BF7\u6C42\u6B21\u6570",undisclosed:"\u672A\u516C\u5F00"};function te(e){return Xe[e.limitType]||"\u672A\u516C\u5F00"}var ae=[{key:"provider",label:"\u54C1\u724C",value:e=>A(e.provider)||"\u2014"},{key:"name",label:"\u5957\u9910\u540D\u79F0",value:e=>R(e.name)||"\u2014"},{key:"monthlyPrice",label:"\u8FDE\u7EED\u5305\u6708",value:e=>O(e.monthlyPrice)},{key:"quarterlyPrice",label:"\u8FDE\u7EED\u5305\u5B63",value:e=>O(e.quarterlyPrice)},{key:"annualPrice",label:"\u8FDE\u7EED\u5305\u5E74",value:e=>O(e.annualPrice)},{key:"billingUnit",label:"\u8BA1\u8D39\u5355\u4F4D",value:e=>te(e)},{key:"quota",label:"\u989D\u5EA6",value:e=>U(e)?.text||"\u2014"},{key:"unitPrice",label:"\u7B49\u6548\u5355\u4EF7",value:e=>N(e)?.text||"\u2014"},{key:"model",label:"\u4EE3\u8868\u6A21\u578B",value:e=>B(e)||"\u2014"},{key:"status",label:"\u72B6\u6001",value:e=>R(e.statusLabel)||"\u2014"},{key:"dataTraining",label:"\u6570\u636E\u8BAD\u7EC3",value:e=>Je(e)},{key:"verifiedAt",label:"\u6838\u5BF9\u65E5\u671F",value:e=>R(e.lastVerifiedAt)||"\u5F85\u6838\u5BF9"},{key:"source",label:"\u6765\u6E90",value:e=>e.url?"\u5B98\u7F51":"\u2014"}],$=D(),T=!1,Ze=new Intl.Collator("zh-CN",{numeric:!0,sensitivity:"base"});function et(e){return e.status==="available"||e.status==="rush_sale"||e.statusLabel==="\u53EF\u7528"||e.statusLabel==="\u53EF\u8D2D\u4E70"}function Ae(){return T}function Vt(){T=!T}function re(e){return ae.find(a=>a.key===e)}function Se(e,a){let t=re(a);return t?String(t.value(e)||"").trim()||"\u2014":""}function tt(){$=D(),T=!1}function j(){return ee($)&&!!re($.column)}function Te(e){let a=e;return T&&(a=a.filter(et)),j()&&(a=we(a,$,Se)),a}function Ce(e,a){return T?`
  ...
  `}function V(e){e&&(e.querySelectorAll(".plan-column-filter-menu").forEach(a=>{a.hidden=!0}),e.querySelectorAll("[data-plan-filter-column]").forEach(a=>{a.setAttribute("aria-expanded","false")}))}function jt(e,a,t,n){e.addEventListener("click",r=>{let s=r.target.closest("[data-plan-filter-column]");if(s&&e.contains(s)){let o=s.closest(".plan-column-filter")?.querySelector(".plan-column-filter-menu");if(!o)return;let u=!o.hidden;V(e),u||(o.hidden=!1,s.setAttribute("aria-expanded","true"));return}let l=r.target.closest("[data-plan-filter-value]");if(l&&e.contains(l)){let o=l.closest("[data-plan-filter-menu]"),u=l.dataset.planFilterValue||"";$=o&&u?D(o.dataset.planFilterMenu,u):D(),t();return}let d=r.target.closest("[data-plan-filter-clear]");if(d&&e.contains(d)){tt(),t();return}let f=r.target.closest("[data-plan-key]");if(f&&e.contains(f)&&!r.target.closest("a")){let o=f.dataset.planKey||"";W(a(),o)&&n(o);return}r.target.closest(".plan-column-filter")||V(e)}),e.addEventListener("keydown",r=>{let s=r.target.closest("[data-plan-key]");if(!s||!e.contains(s)||r.target.closest("a")||r.key!=="Enter"&&r.key!==" ")return;r.preventDefault();let l=s.dataset.planKey||"";W(a(),l)&&n(l)}),document.addEventListener("click",r=>{e.contains(r.target)||V(e)}),document.addEventListener("keydown",r=>{r.key==="Escape"&&V(e)})}var z=2;function rt(e){let a=X(e.lastVerifiedAt);if(a.state==="fresh"){let t=a.days===0?"\u2713 \u4ECA\u65E5\u6838\u5B9E":`\u2713 ${a.days} \u5929\u524D\u6838\u5B9E`;return`<span class="whitespace-nowrap rounded-md bg-emerald-50 px-1.5 py-0.5 text-[10px] font-medium text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-300" title="\u5B98\u65B9\u9875\u6838\u5B9E\u4E8E ${i(a.date)}">${t}</span>`}return a.state==="stale"?`<span class="whitespace-nowrap rounded-md bg-amber-50 px-1.5 py-0.5 text-[10px] font-medium text-amber-600 dark:bg-amber-950/40 dark:text-amber-300" title="\u4E0A\u6B21\u6838\u5B9E ${i(a.date)}\uFF0C\u5DF2\u8D85\u8FC7 30 \u5929">\u5F85\u590D\u6838</span>`:""}function nt(e,a){let t=me(e.provider,a,g),n=be(e,t);return n?`/plans/${encodeURIComponent(n)}/`:""}function st(e,a){let t=Y(e,a,g),n=String(t.seo_slug||"").trim(),r=String(t.seo_intro||"").trim(),s=String(t.icon_url||"").trim();return n&&r&&s?`/brands/${encodeURIComponent(n)}/`:""}function lt(e,a={}){let t=Y(e.provider,a,g);return C(t.icon_url)||C(e.providerIconUrl)||C(fe(e.provider)?.iconUrl)}function E(e,a,t="brand-icon"){let n=C(e),r=String(a||"?").trim().slice(0,1).toUpperCase()||"?",s=n?"brand-icon-fallback hidden":"brand-icon-fallback";return`<span class="${t}" aria-hidden="true">
    ${n?`<img class="brand-icon-img" src="${i(n)}" alt="" loading="lazy" referrerpolicy="no-referrer">`:""}
    <span class="${s}">${i(r)}</span>
  </span>`}function De(e,a){let t=new Map;for(let r of e){let s=t.get(r.provider);s||(s={provider:r.provider,label:A(r.provider,a,g),iconUrl:lt(r,a),brandHref:st(r.provider,a),plans:[]},t.set(r.provider,s)),s.plans.push(r)}let n=[...t.values()];for(let r of n)r.plans=ye(r.plans);return n.sort((r,s)=>Q(r.provider,a,g)-Q(s.provider,a,g)),n}function it(e){return e.status==="available"||e.statusLabel==="\u53EF\u7528"||e.statusLabel==="\u53EF\u8D2D\u4E70"}function ot(e){let a=null;for(let t of e){let n=null;if(Number.isFinite(t.monthlyPriceValue))n=t.monthlyPriceValue;else{let r=String(t.monthlyPrice||"").match(/[\d.]+/),s=r?parseFloat(r[0]):NaN;Number.isFinite(s)&&(n=s)}n==null||n<0||(a==null||n<a)&&(a=n)}return a}function ct(e){let a=ot(e.plans),t=e.plans.filter(it).length,n=[];a!=null&&n.push(a===0?"\u514D\u8D39\u8D77":`\xA5${he(a)} \u8D77`),t>0&&n.push(`${t} \u4E2A\u53EF\u7528`);let r=n.join(" \xB7 ");return`<span class="plan-table-group-summary">${i(r)}</span>`}function dt(e,a){let t=I(e,a,g);return t.training==="no"?`<span class="text-xs font-medium text-emerald-600 dark:text-emerald-400" title="${i(M.no)}">\u4E0D\u8BAD\u7EC3</span>`:t.training==="yes"?`<span class="text-xs font-medium text-amber-600 dark:text-amber-400" title="${i(M.yes)}">\u53EF\u80FD\u8BAD\u7EC3</span>`:t.training==="unclear"?'<span class="text-xs text-slate-500 dark:text-slate-400">\u672A\u660E\u786E</span>':'<span class="text-slate-400">\u2014</span>'}function Ee(e){return e.status==="available"||e.statusLabel==="\u53EF\u7528"||e.statusLabel==="\u53EF\u8D2D\u4E70"?"bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-300":e.status==="rush_sale"?"bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400":"bg-slate-100 text-slate-500 dark:bg-slate-800 dark:text-slate-400"}function ut(e,a="",t="",n=!1){let r=Ee(e),s=e.includedCalls&&e.includedCalls.length>10&&(e.includedCalls.includes("\xA5")||e.includedCalls.includes("\u5143")||e.includedCalls.includes("\u767E\u4E07")),l=$e[e.planType]||e.planType||"",d,f=_e(e);f?d=f:s?d=`<span class="text-sm font-semibold text-slate-700 dark:text-slate-300">${i(e.includedCalls)}</span>`:e.includedCalls||e.planType!=="api-usage"?d='<span class="text-lg font-bold text-slate-500 dark:text-slate-400">\u8BF7\u4EE5\u5B98\u7F51\u4E3A\u51C6</span>':d='<span class="text-lg font-bold text-slate-400 dark:text-slate-500">\u6309\u91CF\u8BA1\u8D39</span>';let o=U(e),u=N(e),y=o||u?`<div class="plan-card-quota-row mt-2 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-slate-500 dark:text-slate-400">
        ${o?`<span title="${i(o.full)}">\u989D\u5EA6\uFF1A${i(o.text)}</span>`:""}
        ${u?`<span class="font-medium text-brand-700 dark:text-brand-300" title="\u6309${i(u.basis)}\u6298\u7B97${u.estimated?"\uFF08\u4F30\u7B97\uFF09":""}">${i(u.text)}</span>`:""}
      </div>`:"";return`
    <div class="plan-card">
  ...
  `}function pt(e,a,t,n,r){return e.length?De(e,t).map(s=>{let l=r||n.has(s.provider),f=(l?s.plans:s.plans.slice(0,z)).map(p=>{let m=K(p),b=m===a,v=p.confidenceScore,h="trust-dot--yellow";v&&v>=.8?h="trust-dot--high":v&&v<.5&&(h="trust-dot--red");let w=[p.domesticPayment?'<span class="plan-card-badge">\u652F\u6301\u56FD\u5185\u652F\u4ED8</span>':"",J(p)?`<span class="plan-card-badge plan-card-badge--intl" title="\u56FD\u9645\u7AD9\u5957\u9910\uFF0C\u4EE5\u7F8E\u5143\u7ED3\u7B97\uFF0C\u8BF7\u8DF3\u8F6C creditsplan.com \u67E5\u770B">\u56FD\u9645 \xB7 ${i(String(p.monthlyCurrency||"USD").toUpperCase())}</span>`:""].filter(Boolean).join(""),P=`<span class="trust-dot ${h}" title="\u53EF\u4FE1\u5EA6: ${v!=null?Math.round(v*100)+"%":"\u672A\u77E5"}"></span>`;return`
        <article class="plan-card-mobile${b?" is-selected":""}">
          <div class="plan-card-toggle" role="button" tabindex="0" data-plan-key="${i(m)}" aria-expanded="${b?"true":"false"}">
            ${ut(p,P,w,b)}
          </div>
          ${b?Z(p,t):""}
        </article>`}).join(""),o=Math.max(0,s.plans.length-z),u=!r&&o>0?`<button type="button" class="plan-group-toggle" data-plan-group-toggle="${i(s.provider)}" aria-expanded="${l?"true":"false"}">${l?"\u6536\u8D77\u591A\u4F59\u5957\u9910":`\u67E5\u770B\u5176\u4F59 ${o} \u4E2A\u5957\u9910`}</button>`:"",y=`${E(s.iconUrl,s.label,"brand-icon brand-icon--section")}
          <h3 class="text-sm font-bold text-brand-800 dark:text-brand-200">${i(s.label)}</h3>`;return`
      <section class="plan-card-group">
        <div class="mb-2 flex items-center gap-2">
          ${s.brandHref?`<a href="${i(s.brandHref)}" class="plan-group-brand-link">${y}</a>`:y}
        ...
        ${u}
      </section>`}).join(""):""}function Ne(e,a,t,n,r=z){let s=t?e.plans:e.plans.slice(0,r);return s.length?s.map(l=>{let d=K(l),f=d===a,o=Ee(l),u=ke(l),y=S(l.monthlyPrice)?`<div>${i(l.monthlyPrice)}</div>${u?`<div class="plan-table-price-first">\u9996\u6708 ${i(u)}</div>`:""}`:'<span class="text-slate-400">\u2014</span>',p=S(l.quarterlyPrice)?`<div>${i(l.quarterlyPrice)}</div>${S(l.quarterlyMonthlyPrice)?`<div class="plan-table-price-sub">\u7EA6 ${i(l.quarterlyMonthlyPrice)}</div>`:""}`:'<span class="text-slate-400">\u2014</span>',m=S(l.annualPrice)?`<div>${i(l.annualPrice)}</div>${S(l.annualMonthlyPrice)?`<div class="plan-table-price-sub">\u7EA6 ${i(l.annualMonthlyPrice)}</div>`:""}`:'<span class="text-slate-400">\u2014</span>',b=U(l),v=b?`<span class="text-slate-700 dark:text-slate-300" title="${i(b.full)}">${i(b.text)}</span>`:'<span class="text-slate-400">\u2014</span>',h=te(l),w=h==="\u672A\u516C\u5F00"?'<span class="text-slate-400">\u2014</span>':`<span class="billing-unit-badge billing-unit-badge--${i(l.limitType||"undisclosed")}">${i(h)}</span>`,P=N(l),Oe=P?`<span class="whitespace-nowrap font-medium text-brand-700 dark:text-brand-300" title="\u6309${i(P.basis)}\u6298\u7B97${P.estimated?"\uFF08\u4F30\u7B97\uFF09":""}">${i(P.text)}</span>`:'<span class="text-slate-400">\u2014</span>',L=X(l.lastVerifiedAt),Ve=L.state==="fresh"?`<span class="text-xs font-medium text-emerald-600 dark:text-emerald-400" title="\u5B98\u65B9\u9875\u6838\u5B9E\u4E8E ${i(L.date)}">\u2713 ${L.days===0?"\u4ECA\u65E5":`${L.days} \u5929\u524D`}</span>`:L.state==="stale"?`<span class="text-xs font-medium text-amber-600 dark:text-amber-400" title="\u4E0A\u6B21\u6838\u5B9E ${i(L.date)}\uFF0C\u5DF2\u8D85\u8FC7 30 \u5929">\u5F85\u590D\u6838</span>`:'<span class="text-xs text-slate-400">\u5F85\u6838\u5BF9</span>',oe=F(l.url),ce=H(l,oe),je=oe?`<a href="${i(ce.href)}" target="_blank" rel="${ce.rel}" ${q(l)} class="text-sm font-medium text-brand-600 hover:text-brand-800 dark:text-brand-400 dark:hover:text-brand-300">\u5B98\u7F51 \u2192</a>`:'<span class="text-slate-400">\u2014</span>',ze=dt(l,n),Ge=f?`<tr class="plan-detail-row">
      ...
      <tr class="plan-select-row${f?" is-selected":""}" data-plan-key="${i(d)}" tabindex="0" aria-selected="${f?"true":"false"}">
        ...
        <td class="break-words px-3 py-3 text-slate-900 dark:text-white">${p}</td>
      ...
      ${Ge}`}).join(""):""}function ft(e,a,t,n,r,s){let l=a.length?De(a,n).map(d=>{if(d.plans.length===1)return Ne(d,t,!0,n);let f=!s&&d.plans.length>z,o=s||!f||r.has(d.provider),u=ct(d),y=`${E(d.iconUrl,d.label,"brand-icon brand-icon--section")}
              <span class="text-sm font-bold text-brand-800 dark:text-brand-200">${i(d.label)}</span>`,p=`
              ${d.brandHref?`<a href="${i(d.brandHref)}" class="plan-table-group-brand">${y}</a>`:y}
        ...
        <tr class="border-y border-slate-200 dark:border-slate-700">
          <td colspan="13" class="bg-brand-50/70 p-0 dark:bg-brand-950/20">
            ${f?`<div class="plan-table-group-toggle" role="button" tabindex="0" data-plan-group-toggle="${i(d.provider)}" aria-expanded="${o?"true":"false"}" aria-label="${o?"\u6536\u8D77":"\u5C55\u5F00"}${i(d.label)}\u5957\u9910">${p}</div>`:`<div class="plan-table-group-toggle plan-table-group-toggle--static">${p}</div>`}
          </td>
        </tr>
        ${Ne(d,t,o,n)}`}).join(""):`<tr>
    ...
    </div>`}function Xt(e,a="",t={},n=new Set,r=!1){if(!e.length)return'<p class="text-sm text-slate-500 dark:text-slate-400">\u540E\u53F0\u6682\u65E0\u5957\u9910\u8BB0\u5F55\u3002</p>';let s=ve(e,t,g);if(!s.length)return'<p class="text-sm text-slate-500 dark:text-slate-400">\u540E\u53F0\u6682\u65E0\u5957\u9910\u8BB0\u5F55\u3002</p>';Le(t);let l=Te(s),d=r||j()||Ae();return`
    <div>
      ${Ce(l,s)}
      ${Ue(l,s)}
    ...
    </div>`}var ne=[{id:"light",label:"\u8F7B\u5EA6 ~500 \u6B21/\u6708",value:500},{id:"medium",label:"\u4E2D\u5EA6 ~3,000 \u6B21/\u6708",value:3e3},{id:"heavy",label:"\u91CD\u5EA6 ~10,000 \u6B21/\u6708",value:1e4},{id:"extreme",label:"\u6781\u91CD ~30,000 \u6B21/\u6708",value:3e4}],bt={\u667A\u8C31:"GLM \u7CFB",KIMI:"Kimi \u7CFB",\u963F\u91CC\u4E91\u767E\u70BC:"Qwen \u7CFB",Qoder:"Qwen \u7CFB",\u706B\u5C71\u5F15\u64CE:"\u8C46\u5305\u7CFB",DeepSeek:"DeepSeek",MiniMax:"MiniMax",\u817E\u8BAF\u6DF7\u5143:"\u6DF7\u5143\u7CFB",\u767E\u5EA6\u5343\u5E06:"\u6587\u5FC3\u7CFB",\u9636\u8DC3\u661F\u8FB0:"Step \u7CFB","Xiaomi MiMo":"MiMo \u7CFB"},Fe=8;function yt(e){return bt[e.provider]||e.provider||"\u5176\u4ED6"}function vt(e,a){let t=new Map;for(let s of e)s.id&&t.set(s.id,yt(s));let n=new Map;for(let s of a){let l=new Set((s.modelIds||[]).map(d=>t.get(d)).filter(Boolean));for(let d of l)n.set(d,(n.get(d)||0)+1)}return{options:[...n.entries()].map(([s,l])=>({family:s,count:l})).sort((s,l)=>l.count-s.count||s.family.localeCompare(l.family,"zh-CN")),familyByModelId:t}}function ht(e,a){return new Set((e.modelIds||[]).map(t=>a.get(t)).filter(Boolean))}function gt(e,a,t){let{families:n,usage:r,rmbOnly:s,budget:l}=a,d=[],f=0;for(let o of e){if(o.planType==="api_package"){f+=1;continue}if(s&&!o.domesticPayment)continue;let u=xe(o);if(l!=null&&u&&u.cny>l)continue;let y=!1;if(n.size){let v=ht(o,t);if(!v.size)y=!0;else if(![...v].some(h=>n.has(h)))continue}let p=ge(o),m=p&&u&&p.value>0?u.cny/p.value*1e3:null,b;y?b=4:p?p.value>=r?b=1:b=2:b=3,d.push({plan:o,price:u,quota:p,costPer1k:m,tier:b})}return d.sort((o,u)=>{if(o.tier!==u.tier)return o.tier-u.tier;if((o.tier===1||o.tier===2)&&o.costPer1k!==u.costPer1k)return(o.costPer1k??1/0)-(u.costPer1k??1/0);let y=o.price?o.price.cny:1/0,p=u.price?u.price.cny:1/0;return y-p}),{results:d,paygoCount:f}}function Ie(e){return Math.round(e).toLocaleString("zh-CN")}function Re(e,a="CNY"){return`${a==="USD"?"$":"\xA5"}${e.toLocaleString("zh-CN",{maximumFractionDigits:e<10?2:0})}`}function xt(e,a){let{plan:t,price:n,quota:r,costPer1k:s,tier:l}=e,d=A(t.provider,a,g),f=[];if(l===1?f.push('<span class="plan-advisor-chip plan-advisor-chip--good">\u989D\u5EA6\u5145\u8DB3</span>'):l===2?f.push('<span class="plan-advisor-chip plan-advisor-chip--warn">\u989D\u5EA6\u53EF\u80FD\u4E0D\u8DB3</span>'):l===3?f.push('<span class="plan-advisor-chip plan-advisor-chip--muted">\u989D\u5EA6\u672A\u516C\u5F00</span>'):f.push('<span class="plan-advisor-chip plan-advisor-chip--muted">\u6A21\u578B\u672A\u6807\u6CE8</span>'),r){let m=r.estimated?`\uFF08${i(r.basis)}\uFF0C\u4F30\u7B97\uFF09`:"";f.push(`<span class="plan-advisor-chip">\u6708\u989D\u5EA6 ~${Ie(r.value)} \u6B21${m}</span>`)}if(s!=null&&f.push(`<span class="plan-advisor-chip">\u6BCF\u5343\u6B21 \u2248 ${Re(s)}</span>`),t.domesticPayment&&f.push('<span class="plan-advisor-chip">\u4EBA\u6C11\u5E01\u76F4\u4ED8</span>'),t.supportedModelNames?.length){let m=t.supportedModelNames.slice(0,3).join(" / ");f.push(`<span class="plan-advisor-chip">\u652F\u6301 ${i(m)}${t.supportedModelNames.length>3?" \u7B49":""}</span>`)}let o='<span class="plan-advisor-price-muted">\u4EF7\u683C\u8BF7\u4EE5\u5B98\u7F51\u4E3A\u51C6</span>';if(n){let m=n.cycle!=="\u6708\u4ED8"?`<span class="plan-advisor-cycle">${i(n.cycle)}</span>`:"",b=n.currency==="USD"?`<span class="plan-advisor-price-note">\u2248 \xA5${Ie(n.cny)}\uFF08\u6309 \xA5${7.2} \u6298\u7B97\uFF09</span>`:"";o=`<span class="plan-advisor-price">${Re(n.value,n.currency)}/\u6708</span>${m}${b}`}let u=F(t.url),y=u?H(t,u):null,p=y?`<a href="${i(y.href)}" target="_blank" rel="${y.rel}" ${q(t)} class="plan-advisor-link">\u5B98\u7F51 \u2192</a>`:"";return`
    <li class="plan-advisor-result">
      ...
      <div class="plan-advisor-result-chips">${f.join("")}</div>
      ${p}
    </li>
    ...
    <div class="plan-advisor-form">
      ...
      <div class="plan-advisor-field plan-advisor-field--row">
        <label class="plan-advisor-switch">
          <input type="checkbox" data-advisor-rmb${a.rmbOnly?" checked":""}>
          <span>\u4EC5\u770B\u652F\u6301\u4EBA\u6C11\u5E01\u76F4\u4ED8</span>
        </label>
